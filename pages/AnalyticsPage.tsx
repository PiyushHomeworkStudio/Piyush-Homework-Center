...
const AnalyticsPage: React.FC = () => {
  ...
  // Filter and Sort: Newest requests first (Top to Bottom)
                    ...
                    >
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 lg:gap-14">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 lg:gap-10 flex-1 w-full pt-8 lg:pt-0 border-t lg:border-t-0 border-white/5">
                          ...
                          <div className="space-y-1">
                            <p className="text-[9px] text-gray-600 uppercase font-black tracking-widest">Payment Method</p>
                            <p className="text-xl sm:text-2xl font-bold text-white uppercase">{req.paymentMethod}</p>
                          </div>
                          <div className="space-y-1">
