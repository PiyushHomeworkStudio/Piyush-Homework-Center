...
const OwnerChatPage: React.FC = () => {
  ...
  // Logic to find last message for a user
  ...
  // Sort users by most recent message activity (LIVE SORTING)
          ...
          <div className="flex-1 overflow-y-auto custom-scroll px-2 pb-6 space-y-1">
            {sortedAndFilteredUsers.map((user) => {
              ...
              return (
                ...
                >
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center font-black text-lg flex-shrink-0 ${isSelected ? 'bg-black text-[#d4af37]' : 'gold-gradient text-black'}`}>
